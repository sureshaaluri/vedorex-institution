...
export interface ApiCoursesPageCoursesPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroctalable: Schema.Attribute.String;
    herodescription: Schema.Attribute.String;
    heroimage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    larningpath: Schema.Attribute.Component<'section.learningpath', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    statStudent: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCoursespageCoursespage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    instuctor: Schema.Attribute.String;
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    nav_links: Schema.Attribute.Component<'nav-link.nav-text', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWelcomePopupeWelcomePopupe extends Struct.SingleTypeSchema {
  collectionName: 'welcome_popupes';
  info: {
    displayName: 'Welcome-popupe';
    pluralName: 'welcome-popupes';
    singularName: 'welcome-popupe';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::welcome-popupe.welcome-popupe'
    > &
      Schema.Attribute.Private;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::coursespage.coursespage': ApiCoursespageCoursespage;
      'api::enrollment.enrollment': ApiEnrollmentEnrollment;
      'api::footer.footer': ApiFooterFooter;
      'api::home-page.home-page': ApiHomePageHomePage;
      'api::navbar.navbar': ApiNavbarNavbar;
      'api::welcome-popupe.welcome-popupe': ApiWelcomePopupeWelcomePopupe;
